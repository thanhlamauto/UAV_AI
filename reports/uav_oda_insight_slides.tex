...
\author[Nguyễn Thanh Lâm, Lê Trung Kiên]{Nguyễn Thanh Lâm \and Lê Trung Kiên}
...
\begin{frame}[plain]
  ...
  \vspace{1.0cm}
  {\color{odaNavy}\bfseries Nguyễn Thanh Lâm\\Lê Trung Kiên\par}
  \vspace{0.08cm}
  {\scriptsize\color{odaMuted}thanhlamtba@gmail.com\\kienlt23@gmail.com\par}
  \vspace{0.15cm}
