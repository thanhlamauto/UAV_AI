...
python3 experiments/cache_monocular_depth_batch.py --readiness outputs/tables/target_50_trials_readiness.csv --model-id depth-anything/Depth-Anything-V2-Small-hf --batch-size 8 --fps 5 --device cuda
